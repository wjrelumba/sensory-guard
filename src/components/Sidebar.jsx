...
export default function Sidebar({shown,toggleSideBar}) {
  ...
  return (
    <div className={`w-[50%] h-full top-0 bottom-0 bg-gray-200 fixed border-r-[2px] ${shown === false ? (hasLoaded ? 'slide-left-out' : 'ml-[-100%]') : 'slide-right'} p-2 flex flex-col`}>
        <div className='w-full flex justify-end items-center px-2 mb-2 text-gray-600'>
